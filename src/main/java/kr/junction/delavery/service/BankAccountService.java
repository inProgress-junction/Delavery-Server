...
public class BankAccountService implements BankAccountUseCase {
    ...
    public BankAccount transferToBankAccount(String memberId, Integer money) {
        ...
        List<BankAccount> accountsToTransfer = Arrays.asList(spendingAccount.subtractMoney(money), savingAccount.addMoney(money));
        bankAccountRepository.saveAll(accountsToTransfer);
